...
```
cd existing_repo
git remote add origin https://gitlab.beckettcloud.com/homelab/ha-dashboard.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.beckettcloud.com/homelab/ha-dashboard/-/settings/integrations)
